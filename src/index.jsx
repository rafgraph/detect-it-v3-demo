...
function App() {
  ...
  return (
    <div style={styles.app}>
      ...
      <div style={styles.repoLink}><a href="https://github.com/rafrex/detect-it" target="_blank" rel="noopener noreferrer">https://github.com/rafrex/detect-it</a></div>
      ...
      <div style={styles.repoLink}><a href="https://github.com/rafrex/detect-hover" target="_blank" rel="noopener noreferrer">https://github.com/rafrex/detect-hover</a></div>
      <div style={styles.code}>
        <div style={styles.detects}>
      ...
      <div style={styles.repoLink}><a href="https://github.com/rafrex/detect-pointer" target="_blank" rel="noopener noreferrer">https://github.com/rafrex/detect-pointer</a></div>
      <div style={styles.code}>
        <div style={styles.detects}>
      ...
      <div style={styles.repoLink}><a href="https://github.com/rafrex/detect-touch-events" target="_blank" rel="noopener noreferrer">https://github.com/rafrex/detect-touch-events</a></div>
      <div style={styles.code}>
        <div style={styles.detects}>
      ...
      <div style={styles.repoLink}><a className="test" href="https://github.com/rafrex/detect-passive-events" target="_blank" rel="noopener noreferrer">https://github.com/rafrex/detect-passive-events</a></div>
      <div style={styles.code}>
        <div style={styles.detects}>
      ...
      <div style={styles.creditLink}><a className="extended-link" href="http://www.rafaelpedicini.com" target="_blank" rel="noopener noreferrer">Code and concept by <span>Rafael Pedicini</span></a></div>
    </div>
  );
}
